...
#
OBJS = server.o request.o segel.o client.o FIFO_queue.o
TARGET = server
...
server: server.o request.o segel.o FIFO_queue.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o FIFO_queue.o $(LIBS)
